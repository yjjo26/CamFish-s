...
-- ===================
-- 8. SPOT_SPECIES_SEASON (낚시 포인트-어종-시즌 연결)
-- ===================
-- 을왕리 선녀바위
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'WINTER', '겨울철 락피쉬 포인트. 갯바위 심층 공략'
FROM public.places p, public.fish_species s
WHERE p.name = '을왕리 선녀바위' AND s.korean_name = '우럭'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '가을철 광어 다운샷 시즌'
FROM public.places p, public.fish_species s
WHERE p.name = '을왕리 선녀바위' AND s.korean_name = '광어'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'SPRING', '봄철 우럭 피크 시즌'
FROM public.places p, public.fish_species s
WHERE p.name = '을왕리 선녀바위' AND s.korean_name = '우럭'
ON CONFLICT DO NOTHING;
...
-- 궁평항 피싱피어
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '가을철 망둥어 생활낚시'
FROM public.places p, public.fish_species s
WHERE p.name = '궁평항 피싱피어' AND s.korean_name = '망둥어'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'SUMMER', '여름철 숭어 원투'
FROM public.places p, public.fish_species s
...
-- 시화방조제
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '삼치 루어 시즌'
FROM public.places p, public.fish_species s
WHERE p.name = '시화방조제' AND s.korean_name = '삼치'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'WINTER', '겨울철 우럭 포인트'
FROM public.places p, public.fish_species s
...
-- 무의도 광명항
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '가을 쭈꾸미 에깅 시즌'
FROM public.places p, public.fish_species s
WHERE p.name = '무의도 광명항' AND s.korean_name = '쭈꾸미'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'SPRING', '봄 갑오징어 시즌'
FROM public.places p, public.fish_species s
...
-- 주문진항 방파제
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '가을 고등어 카드채비'
FROM public.places p, public.fish_species s
WHERE p.name = '주문진항 방파제' AND s.korean_name = '고등어'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'WINTER', '겨울 감성돔 찌낚시'
FROM public.places p, public.fish_species s
...
-- 보령 대천항
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '쭈꾸미 에깅 성지'
FROM public.places p, public.fish_species s
...
-- 목포 북항
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '갈치 밤낚시의 꽃'
FROM public.places p, public.fish_species s
...
-- 기장 죽성성당
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'SUMMER', '농어 루어낚시'
FROM public.places p, public.fish_species s
WHERE p.name = '부산 기장 죽성성당' AND s.korean_name = '농어'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '무늬오징어 에깅'
FROM public.places p, public.fish_species s
...
-- 여수 국동항
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '갑오징어/쭈꾸미 성지'
FROM public.places p, public.fish_species s
...
-- 제주 차귀도
INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'SUMMER', '돌돔 포인트'
FROM public.places p, public.fish_species s
WHERE p.name = '제주 차귀도 포구' AND s.korean_name = '돌돔'
ON CONFLICT DO NOTHING;

INSERT INTO public.spot_species_season (place_id, species_id, season, fishing_tip)
SELECT p.id, s.id, 'AUTUMN', '고등어 손맛'
FROM public.places p, public.fish_species s
WHERE p.name = '제주 차귀도 포구' AND s.korean_name = '고등어'
ON CONFLICT DO NOTHING;

-- ===================
-- 9. SPECIES_BAIT_MAP (어종-미끼 연결)
-- ===================
-- 우럭
INSERT INTO public.species_bait_map (species_id, bait_id, effectiveness_score)
SELECT s.id, b.id, 8
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '우럭' AND b.name = '갯지렁이 (청개비)'
ON CONFLICT DO NOTHING;

INSERT INTO public.species_bait_map (species_id, bait_id, effectiveness_score)
SELECT s.id, b.id, 7
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '우럭' AND b.name = '다운샷 웜 (Downshot Worm)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '쭈꾸미' AND b.name = '에기 (Egi)'
ON CONFLICT DO NOTHING;

INSERT INTO public.species_bait_map (species_id, bait_id, effectiveness_score)
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '갑오징어' AND b.name = '에기 (Egi)'
ON CONFLICT DO NOTHING;

INSERT INTO public.species_bait_map (species_id, bait_id, effectiveness_score)
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '무늬오징어' AND b.name = '에기 (Egi)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '감성돔' AND b.name = '크릴 (Krill)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 8
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '고등어' AND b.name = '카드채비 (Sabiki)'
ON CONFLICT DO NOTHING;

INSERT INTO public.species_bait_map (species_id, bait_id, effectiveness_score)
SELECT s.id, b.id, 7
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '고등어' AND b.name = '크릴 (Krill)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '삼치' AND b.name = '메탈지그 (Metal Jig)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 8
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '갈치' AND b.name = '지그헤드'
ON CONFLICT DO NOTHING;

INSERT INTO public.species_bait_map (species_id, bait_id, effectiveness_score)
SELECT s.id, b.id, 7
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '갈치' AND b.name = '오징어 살'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '방어' AND b.name = '메탈지그 (Metal Jig)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 8
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '농어' AND b.name = '미노우'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 8
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '볼락' AND b.name = '지그헤드'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 8
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '망둥어' AND b.name = '갯지렁이 (청개비)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '돌돔' AND b.name = '크릴 (Krill)'
ON CONFLICT DO NOTHING;
...
SELECT s.id, b.id, 9
FROM public.fish_species s, public.baits b
WHERE s.korean_name = '배스' AND b.name = '다운샷 웜 (Downshot Worm)'
ON CONFLICT DO NOTHING;
